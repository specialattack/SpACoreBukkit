...
public final class Cuboid {
	...
	public boolean collidesWith(Cuboid cuboid) {
		if (this.getWorld() != cuboid.getWorld()) return false;

		boolean inX = cuboid.getEndX() > this.getStartX() && cuboid.getStartX() < this.getEndX();
		boolean inY = cuboid.getEndY() > this.getStartY() && cuboid.getStartY() < this.getEndY();
		boolean inZ = cuboid.getEndZ() > this.getStartZ() && cuboid.getStartZ() < this.getEndZ();
	...
	public boolean contains(Location location){
		if (location.getWorld() != this.end.getWorld()) return false;
		
		boolean x = location.getX() > this.getStartX() && location.getX() < this.getEndX();
		boolean y = location.getY() > this.getStartY() && location.getY() < this.getEndY();
		boolean z = location.getZ() > this.getStartZ() && location.getZ() < this.getEndZ();
